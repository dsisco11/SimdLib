...
foreach(simdlib_development_module IN LISTS simdlib_development_modules)
    ...
    if(simdlib_development_module STREQUAL "PartialRegisterCodegen")
        option(SIMDLIB_BUILD_CODEGEN_PILOT "Build the provisional LLVM instruction-contract pilot" OFF)
        if(SIMDLIB_BUILD_CODEGEN_PILOT)
            include("${CMAKE_CURRENT_LIST_DIR}/CodegenPilot.cmake")
        endif()
    endif()
endforeach()
