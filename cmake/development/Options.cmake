...
set(SIMDLIB_DEFAULT_CHECKS_PROBE "NONE" CACHE STRING
    "Default checks-state contract: NONE, RELEASE, or DEBUG")
set_property(CACHE SIMDLIB_DEFAULT_CHECKS_PROBE PROPERTY STRINGS
    NONE RELEASE DEBUG)
if(NOT SIMDLIB_DEFAULT_CHECKS_PROBE MATCHES "^(NONE|RELEASE|DEBUG)$")
    message(FATAL_ERROR
        "SIMDLIB_DEFAULT_CHECKS_PROBE has unsupported value "
        "'${SIMDLIB_DEFAULT_CHECKS_PROBE}'")
endif()

set(SIMDLIB_VALIDATION_PROFILE "CUSTOM" CACHE STRING
    "Validation ownership profile: CUSTOM, RELEASE, DEBUG, SANITIZER, COVERAGE, CODEGEN_DIAGNOSTIC, or COMPILER_CONTRACTS")
set_property(CACHE SIMDLIB_VALIDATION_PROFILE PROPERTY STRINGS
    CUSTOM RELEASE DEBUG SANITIZER COVERAGE CODEGEN_DIAGNOSTIC COMPILER_CONTRACTS)
...
set(SIMDLIB_REGISTER_CODEGEN_MODE "OFF" CACHE STRING
    "Register generated-code policy: OFF, ENFORCE, or RECORD")
set_property(CACHE SIMDLIB_REGISTER_CODEGEN_MODE PROPERTY STRINGS
    OFF ENFORCE RECORD)
if(NOT SIMDLIB_REGISTER_CODEGEN_MODE MATCHES "^(OFF|ENFORCE|RECORD)$")
    message(FATAL_ERROR
        "SIMDLIB_REGISTER_CODEGEN_MODE must be OFF, ENFORCE, or RECORD; got "
        "'${SIMDLIB_REGISTER_CODEGEN_MODE}'")
endif()
