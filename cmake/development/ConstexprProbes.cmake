...
if(SIMDLIB_BUILD_CONSTEXPR_PROBES)
	...
	foreach(uint128_profile IN ITEMS Optimized Portable Scalar)
		...
		if(uint128_profile STREQUAL "Optimized")
			target_compile_definitions(${target} PRIVATE SIMDLIB_HAS_BMI1=1)
		elseif(uint128_profile STREQUAL "Portable")
			target_compile_definitions(${target} PRIVATE SIMDLIB_HAS_BMI1=0)
		endif()
		...
		elseif(SIMDLIB_MSVC_STYLE_DRIVER)
			...
			if(uint128_profile STREQUAL "Optimized")
				target_compile_options(${target} PRIVATE -msse4.2 -mbmi)
			else()
				target_compile_options(${target} PRIVATE -msse4.2 -mno-bmi)
			endif()
		endif()
	endforeach()
