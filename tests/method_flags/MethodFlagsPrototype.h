...
#define SIMDLIB_DETAIL_FLAGS_MODIFIERS_2_RegisterOnly_ForceInline SIMDLIB_DETAIL_FLAGS_FORCE_INLINE SIMDLIB_DETAIL_FLAGS_REGISTER_ONLY
#define SIMDLIB_DETAIL_FLAGS_MODIFIERS_2_RegisterOnly_Flatten SIMDLIB_DETAIL_FLAGS_FLATTEN SIMDLIB_DETAIL_FLAGS_REGISTER_ONLY
#define SIMDLIB_DETAIL_FLAGS_MODIFIERS_2_ForceInline_Flatten SIMDLIB_DETAIL_FLAGS_FLATTEN SIMDLIB_DETAIL_FLAGS_FORCE_INLINE
#define SIMDLIB_DETAIL_FLAGS_MODIFIERS_3_RegisterOnly_ForceInline_Flatten                                                                                      \
	SIMDLIB_DETAIL_FLAGS_FLATTEN SIMDLIB_DETAIL_FLAGS_FORCE_INLINE SIMDLIB_DETAIL_FLAGS_REGISTER_ONLY
