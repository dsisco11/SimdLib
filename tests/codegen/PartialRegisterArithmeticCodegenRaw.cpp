...
[[nodiscard]] typename api_t::vector_t SIMD_FLAGS(InOut, RegisterOnly, ForceInline, Flatten) project(typename api_t::vector_t native) noexcept
{
...
template <class element_t, class api_t, std::size_t active_lane_count>
[[nodiscard]] typename api_t::vector_t SIMD_FLAGS(InOut, RegisterOnly, ForceInline, Flatten) neutralize_divisors(typename api_t::vector_t native) noexcept
{
...
[[nodiscard]] typename api_t::vector_t SIMD_FLAGS(InOut, RegisterOnly, ForceInline, Flatten) apply_position_sentinel(typename api_t::vector_t native) noexcept
{
	constexpr auto identity = []() constexpr
	{
		std::array<element_t, api_t::element_count> result{};
...
extern "C" [[nodiscard]] typename partial_i32::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_add(typename partial_i32::vector_t lhs, typename partial_i32::vector_t rhs) noexcept
{
	return partial_i32::add(rhs, lhs);
}

/** @brief Raw API mirror for projected partial-register subtraction. */
extern "C" [[nodiscard]] typename partial_f32::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_subtract(typename partial_f32::vector_t lhs, typename partial_f32::vector_t rhs) noexcept
{
...
extern "C" [[nodiscard]] typename partial_i32::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_multiply(typename partial_i32::vector_t lhs, typename partial_i32::vector_t rhs) noexcept
{
...
extern "C" [[nodiscard]] typename partial_i32::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_divide(typename partial_i32::vector_t lhs, typename partial_i32::vector_t rhs) noexcept
{
	using api_t = partial_i32;
	return project<std::int32_t, api_t, i32_lanes>(api_t::divide(lhs, neutralize_divisors<std::int32_t, api_t, i32_lanes>(rhs)));
}

/** @brief Raw API mirror for neutralized partial-register modulus. */
extern "C" [[nodiscard]] typename partial_i32::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_modulus(typename partial_i32::vector_t lhs, typename partial_i32::vector_t rhs) noexcept
{
	using api_t = partial_i32;
	return project<std::int32_t, api_t, i32_lanes>(api_t::modulus(lhs, neutralize_divisors<std::int32_t, api_t, i32_lanes>(rhs)));
}

/** @brief Raw API mirror for projected partial-register negation. */
extern "C" [[nodiscard]] typename partial_f32::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_negate(typename partial_f32::vector_t value) noexcept
{
	using api_t = partial_f32;
...
extern "C" [[nodiscard]] typename partial_i32::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_min(typename partial_i32::vector_t lhs, typename partial_i32::vector_t rhs) noexcept
{
...
extern "C" [[nodiscard]] typename partial_i32::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_max(typename partial_i32::vector_t lhs, typename partial_i32::vector_t rhs) noexcept
{
...
extern "C" [[nodiscard]] typename partial_i32::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_absolute(typename partial_i32::vector_t value) noexcept
{
...
extern "C" [[nodiscard]] typename partial_f32::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_sqrt(typename partial_f32::vector_t value) noexcept
{
	return partial_f32::sqrt(value);
}

/** @brief Raw API mirror for partial-register average. */
extern "C" [[nodiscard]] typename partial_u8::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_average(typename partial_u8::vector_t lhs, typename partial_u8::vector_t rhs) noexcept
{
	return partial_u8::avg(lhs, rhs);
}

/** @brief Raw API mirror for partial-register multiply-add. */
extern "C" [[nodiscard]] typename partial_f32::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS simdlib_partial_arithmetic_codegen_multiply_add(
	typename partial_f32::vector_t lhs, typename partial_f32::vector_t rhs, typename partial_f32::vector_t addend) noexcept
{
#if SIMDLIB_COMPILER_GCC
	return partial_f32::multiply_add(lhs, rhs, addend);
#else
...
extern "C" [[nodiscard]] typename partial_i32::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_magnitude(typename partial_i32::vector_t value) noexcept
{
	using api_t = partial_i32;
...
extern "C" [[nodiscard]] typename partial_i16::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_magnitude_checked(typename partial_i16::vector_t value) noexcept
{
...
extern "C" [[nodiscard]] typename partial_f32::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_normalize(typename partial_f32::vector_t value) noexcept
{
	using api_t = partial_f32;
...
extern "C" [[nodiscard]] typename partial_i16::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_horizontal_add(typename partial_i16::vector_t lhs, typename partial_i16::vector_t rhs) noexcept
{
...
extern "C" [[nodiscard]] typename partial_i16::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_horizontal_subtract(typename partial_i16::vector_t lhs, typename partial_i16::vector_t rhs) noexcept
{
	using api_t = partial_i16;
...
extern "C" [[nodiscard]] typename partial_i16::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_multiply_add_adjacent(typename partial_i16::vector_t lhs, typename partial_i16::vector_t rhs) noexcept
{
...
extern "C" [[nodiscard]] typename partial_u8::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_byte_multiply_add(typename partial_u8::vector_t lhs, typename partial_u8::vector_t rhs) noexcept
{
...
extern "C" [[nodiscard]] typename partial_u8::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_sad(typename partial_u8::vector_t lhs, typename partial_u8::vector_t rhs) noexcept
{
...
extern "C" [[nodiscard]] typename partial_u8::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_multi_sad(typename partial_u8::vector_t lhs, typename partial_u8::vector_t rhs) noexcept
{
...
extern "C" [[nodiscard]] std::size_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_min_position(typename partial_i16::vector_t value) noexcept
{
	using api_t = partial_i16;
...
extern "C" [[nodiscard]] std::size_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_max_position(typename partial_i16::vector_t value) noexcept
{
	using api_t = partial_i16;
...
extern "C" [[nodiscard]] typename partial_u8::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_add_saturated(typename partial_u8::vector_t lhs, typename partial_u8::vector_t rhs) noexcept
{
...
extern "C" [[nodiscard]] typename partial_u8::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_subtract_saturated(typename partial_u8::vector_t lhs, typename partial_u8::vector_t rhs) noexcept
{
...
extern "C" [[nodiscard]] typename partial_i16::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_horizontal_add_saturated(typename partial_i16::vector_t lhs, typename partial_i16::vector_t rhs) noexcept
{
	using api_t = partial_i16;
...
extern "C" [[nodiscard]] typename partial_i16::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_horizontal_subtract_saturated(typename partial_i16::vector_t lhs, typename partial_i16::vector_t rhs) noexcept
{
	using api_t = partial_i16;
...
extern "C" [[nodiscard]] typename partial_f32::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_add_subtract(typename partial_f32::vector_t lhs, typename partial_f32::vector_t rhs) noexcept
{
	using api_t = partial_f32;
...
extern "C" [[nodiscard]] typename partial_f32::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_dot_product(typename partial_f32::vector_t lhs, typename partial_f32::vector_t rhs) noexcept
{
...
extern "C" [[nodiscard]] typename partial_i64::vector_t SIMDLIB_METHOD_FLAGS_SAFE_BUFFERS
simdlib_partial_arithmetic_codegen_sparse_adjacent(typename partial_i64::vector_t lhs, typename partial_i64::vector_t rhs) noexcept
{
#if SIMDLIB_COMPILER_GCC
	return partial_i64::multiply_add_adjacent(lhs, rhs);
#else
